...
const nounsList = [
    ...
    [
        ...
        { group: 1, pl: 'krótkie spodenki', en: '', note: 'shorts' },
        { group: 1, pl: 'gotówka', en: 'cash', note: '' },
        { group: 1, pl: 'sweter', en: 'jumper', note: 'jumper<u>s</u>' },
        { group: 1, pl: 'przewidywanie / prognoza', en: 'forecast', note: 'forecast<u>s</u>' },
        ...
        { group: 1, pl: 'grzmot', en: 'thunder', note: 'thunder<u>s</u>' },
        { group: 1, pl: 'paragon', en: 'receipt', note: 'receipt<u>s</u>' },
        { group: 1, pl: 'burza / nawałnica', en: 'storm', note: 'storms<u>s</u>' },
        { group: 1, pl: 'grad', en: 'hail', note: 'hail<u>s</u>' },
        { group: 1, pl: 'Irlandia', en: 'Ireland', note: '' },
        { group: 1, pl: 'poczta', en: 'post', note: 'post<u>s</u>' },
        { group: 1, pl: 'Hiszpania', en: 'Spain', note: '' },
        { group: 1, pl: 'Wielka Brytania', en: 'Great Britain', note: '' },
        { group: 1, pl: 'Czechy / Republika Czaska', en: 'the Czech Republic', note: '' },
        { group: 1, pl: 'Węgry', en: 'Hungary', note: '' },
        { group: 1, pl: 'paczka', en: 'package', note: '' },
        { group: 1, pl: 'Szwajcaria', en: 'Switzerland', note: '' },
        { group: 1, pl: 'znaczek', en: 'stamp', note: '' },
        { group: 1, pl: 'list', en: 'letter', note: '' },
        { group: 1, pl: 'Dania', en: 'Denmark', note: '' },
        { group: 1, pl: 'Austria', en: 'Austria', note: '' },
        { group: 1, pl: 'koperta', en: 'envelope', note: '' },
        { group: 1, pl: 'Rosja', en: 'Russia', note: '' },
        { group: 1, pl: 'Grecja', en: 'Greece', note: '' },
        { group: 1, pl: 'kod pocztowy', en: 'postcode', note: '' },
        { group: 1, pl: 'Polska', en: 'Poland', note: '' },
        { group: 1, pl: 'Holandia', en: 'the Netherlands', note: '' },
        { group: 1, pl: 'Szwecja', en: 'Sweden', note: '' },
        { group: 1, pl: 'Włochy', en: 'Italy', note: '' },
        { group: 1, pl: 'Francja', en: 'France', note: '' },
        { group: 1, pl: 'wiadomość', en: 'message', note: '' },
        { group: 1, pl: 'wiadomość spam / spam', en: 'spam', note: '' },
        { group: 1, pl: 'Niemcy', en: 'Germany', note: '' },
        { group: 1, pl: 'Ukraina', en: 'Ukraine', note: '' },
        { group: 1, pl: 'Warszawa', en: 'Warsaw', note: '' },
        { group: 1, pl: 'Berlin', en: 'Berlin', note: '' },
        { group: 1, pl: 'Londyn', en: 'London', note: '' },
        { group: 1, pl: 'Paryż', en: 'Paris', note: '' },
        { group: 1, pl: 'Madryt', en: 'Madrid', note: '' },
        { group: 1, pl: 'Rzym', en: 'Rome', note: '' },
        { group: 1, pl: 'Dublin', en: 'Dublin', note: '' },
        { group: 1, pl: 'Ateny', en: 'Athens', note: '' },
        { group: 1, pl: 'Budapeszt', en: 'Budapest', note: '' },
        { group: 1, pl: 'Wiedeń', en: 'Vienna', note: '' },
        { group: 1, pl: 'Praga', en: 'Prague', note: '' },
        { group: 1, pl: 'Kijów', en: 'Kiev', note: '' },
        { group: 1, pl: 'Moskwa', en: 'Moscow', note: '' },
        { group: 1, pl: 'Kopenhaga', en: 'Copenhagen', note: '' },
        { group: 1, pl: 'krowa', en: 'cow', note: 'cow<u>s</u>' },
        { group: 1, pl: 'świnia', en: 'pig', note: 'pig<u>s</u>' },
        { group: 1, pl: 'kurczak', en: 'chicken', note: 'chicken<u>s</u>' },
        { group: 1, pl: 'kura (samica kury)', en: 'hen', note: 'hen<u>s</u>' },
        { group: 1, pl: 'kogut (samiec kury)', en: 'cock', note: 'cock<u>s</u>' },
        { group: 1, pl: 'kaczka', en: 'duck', note: 'duck<u>s</u>' },
        { group: 1, pl: 'osioł', en: 'donkey', note: 'donkey<u>s</u>' },
        { group: 1, pl: 'owieczka / jagnię', en: 'lamb', note: 'lamb<u>s</u>' },
        { group: 1, pl: 'koza / kozioł', en: 'goat', note: 'goat<u>s</u>' },
        { group: 1, pl: 'byk', en: 'bull', note: 'bull<u>s</u>' },
        { group: 1, pl: 'szafa', en: 'wardrobe', note: 'wardrobe<u>s</u>' },
        { group: 1, pl: 'owad', en: 'insect', note: 'insect<u>s</u>' },
        { group: 1, pl: 'mrówka', en: 'ant', note: 'ant<u>s</u>' },
        { group: 1, pl: 'komar', en: 'mosquito', note: 'mosquito<u>s</u>' },
        { group: 1, pl: 'chrząszcz / żuk', en: 'beetle', note: 'beetle<u>s</u>' },
        { group: 1, pl: 'konik polny', en: 'grasshopper', note: 'grasshopper<u>s</u>' },
        { group: 1, pl: 'pchła', en: 'flea', note: 'flea<u>s</u>' },
        { group: 1, pl: 'kleszcz', en: 'tick', note: 'tick<u>s</u>' },
        { group: 1, pl: 'pająk', en: 'spider', note: 'spider<u>s</u>' },
        { group: 1, pl: 'ślimak', en: 'snail', note: 'snail<u>s</u>' },
        { group: 1, pl: 'żaba', en: 'frog', note: 'frog<u>s</u>' },
        { group: 1, pl: 'szczur', en: 'rat', note: 'rat<u>s</u>' },
        { group: 1, pl: 'wróbel', en: 'sparrow', note: 'sparrow<u>s</u>' },
        { group: 1, pl: 'gołąb', en: 'pigeon', note: 'pigeon<u>s</u>' },
        { group: 1, pl: 'dżdżownica', en: 'worm', note: 'worm<u>s</u>' },
        { group: 1, pl: 'jaszczurka', en: 'lizard', note: 'lizard<u>s</u>' },
        { group: 1, pl: 'sowa', en: 'owl', note: 'owl<u>s</u>' },
        { group: 1, pl: 'wiewiórka', en: 'squirrel', note: 'squirrel<u>s</u>' },
        { group: 1, pl: 'pingwin', en: 'penguin', note: 'penguin<u>s</u>' },
        { group: 1, pl: 'zając', en: 'hare', note: 'hare<u>s</u>' },
        { group: 1, pl: 'trójkąt (figura geometryczna)', en: 'triangle', note: 'triangle<u>s</u>' },
        { group: 1, pl: 'opieka medyczna / leczenie / kuracja', en: 'treatment', note: 'treatment<u>s</u>' },
        { group: 1, pl: 'gwiazda', en: 'star', note: 'star<u>s</u>' },
        { group: 1, pl: 'rozmiar', en: 'size', note: 'size<u>s</u>' },
        { group: 1, pl: 'śpiwór', en: 'sleeping bag', note: 'sleeping bags<u>s</u>' },
        { group: 1, pl: 'paszport', en: 'passport', note: 'passport<u>s</u>' },
        { group: 1, pl: 'obóz / obozowisko', en: 'camp', note: 'camp<u>s</u>' },
        { group: 1, pl: 'muzeum', en: 'museum', note: 'museum<u>s</u>' },
        { group: 1, pl: 'mapa', en: 'map', note: 'map<u>s</u>' },
    ],
];
