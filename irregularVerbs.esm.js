...
const irregularVerbsList = [
    ...
    [
        ...
        { group: 1, pl: 'ustawić / ustalać', en: 'set', note: 'set / set' },
        ...
        { group: 1, pl: 'opuścić / porzucić', en: 'forsake', note: 'forsook / forsook' },
        ...
        { group: 1, pl: 'być', en: 'be', note: 'was / were' },
        ...
        { group: 1, pl: 'zamrarzać', en: 'freeze', note: 'froze / frozen' },
