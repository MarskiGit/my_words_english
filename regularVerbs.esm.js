...
const regularVerbsList = [
    ...
    [
        ...
        { group: 1, pl: 'powtażać / powiedzieć coś ponownie', en: 'repeat', note: 'repeat<u>ed</u>' },
        { group: 1, pl: 'paspwać / być dobrego rozmiaru', en: 'fit', note: 'fit<u>ed</u>' },
        { group: 1, pl: 'wybierać numer telefonu', en: 'dial', note: 'dial<u>ed</u>' },
        { group: 1, pl: 'kończyć się', en: 'end', note: 'end<u>ed</u>' },
        { group: 1, pl: 'witaś się / przywitać się', en: 'greet', note: 'greet<u>ed</u>' },
        { group: 1, pl: 'mrugnać', en: 'wink', note: 'wink<u>ed</u>' },
        { group: 1, pl: 'machać', en: 'wave', note: 'wave<u>ed</u>' },
        { group: 1, pl: 'pachać', en: 'push', note: 'push<u>ed</u>' },
        { group: 1, pl: 'sprzeczać się / kłócić się', en: 'argue', note: 'argu<u>ed</u>' },
        { group: 1, pl: 'komunikować / kontaktować się', en: 'communicate', note: 'communicat<u>ed</u>' },
        { group: 1, pl: 'ciągnąć', en: 'pull', note: 'pull<u>ed</u>' },
        { group: 1, pl: 'odpowiadać', en: 'replay', note: 'replai<u>ed</u>' },
        { group: 1, pl: 'szeptać', en: 'whisper', note: 'whisper<u>ed</u>' },
        { group: 1, pl: 'dyskutować', en: 'discuss', note: 'discu<u>ed</u>' },
    ],
];
