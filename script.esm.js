    ...
    eventListeners()
        {
            ...
            document.querySelector('[data-pl="ASC"]').
                    addEventListener('click', view.plASC);
            document.querySelector('[data-pl="DSC"]').
                    addEventListener('click', view.plDSC);
            document.querySelector('[data-en="ASC"]').
                    addEventListener('click', view.enASC);
            document.querySelector('[data-en="DSC"]').
                    addEventListener('click', view.enDSC);
            document.querySelector('[data-irr="ASC"]').
                    addEventListener('click', view.irrASC);
            document.querySelector('[data-irr="DSC"]').
                    addEventListener('click', view.irrDSC);
        }
    start()
        {
